...
//  UnsupportedHandler onUnsupported;
  ...
  Future<String?> togglePlaneRenderer() async {
    return _channel.invokeMethod<String>('togglePlaneRenderer');
  }

  Future<String?> getTrackingState() async {
    return _channel.invokeMethod<String>('getTrackingState');
  }
  ...
  Map<String, dynamic> _getHandlerParams(ArCoreNode node, Map<String, dynamic>? params) {
    final Map<String, dynamic> values = <String, dynamic>{'name': node.name}..addAll(params ?? Map());
    return values;
  }
